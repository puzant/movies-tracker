          ...
          >
            <div className="flex flex-col sm:flex-row items-center m-auto gap-9 py-8 w-full md:w-[90%] lg:w-[85%]">
              <img
                ...
                src={`https://image.tmdb.org/t/p/w300_and_h450_bestv2/${movieDetails.data.poster_path}`}
              />
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex flex-col gap-2.5 mt-2 items-center sm:items-start">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="antialiased text-white">
                      {movieDetails.data.status}
                    </div>
                  </div>

                  <div className="flex flex-col">
                    <div className="font-bold text-white">Overview:</div>
                    <div className="antialiased leading-7 w-full sm:w-[90%] text-white mt-1">
            ...
            <div className="flex flex-col w-full md:w-[70%] lg:w-[80%]">
              ...
              <div className="flex md:hidden flex-col gap-2 mt-4 px-4">
                <div className="flex gap-2">
                  ...
                  <span>
                    {getMovieLanguage(movieDetails.data.original_language)}
                  </span>
                </div>
              ...
              <div className="text-md font-semibold hover:text-gray-500 cursor-pointer mt-8">
                Full Cast & Crew
              </div>
              ...
              {movieDetails.data.reviews.results
                .slice(0, 1)
                .map((review: IReview) => (
